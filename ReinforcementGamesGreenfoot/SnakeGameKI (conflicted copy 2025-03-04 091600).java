...
public class SnakeGameKI extends SnakeGame
{
    ...
    public SnakeGameKI() {
        super(); //#calls setup
        wins = new int[getSnakes().length];
        losses = new int[getSnakes().length];
     ...
     * @param playerNumber Nummer des Spielers
     */
    ...
    /**
     * Laedt ein gespeichertes Neuronales Netz und stattet den gewaehlten Spieler damit aus,
     * sofern der ein NeuralAgent ist. Der Dateiname muss dem Format entsprechen.
     * @param playerNumber Nummer des Spielers
     * @param Dateiname
     */
